...
source('~\\msu\\microbiome_trait_succession\\succession_analysis.R')
...
png(filename = paste0(image_dir, "figTaxOverTime", '.png'), units = 'in', type = "cairo", width = 6, height = 6, res = 300)
grid::grid.draw(figTaxOverTime)
while(dev.cur() != 1) dev.off()

pdf(file = paste0(image_dir, "figTaxOverTime", '.pdf'), width = 6, height = 6)
grid::grid.draw(figTaxOverTime)
while(dev.cur() != 1) dev.off()
...
plot_it(figCWMs, name = 'figCWMs', dir = image_dir, width = 6.5, height = 7, png = FALSE, pdf = TRUE)
...
plot_it(figCWMsTreat, name = 'figCWMsTreat', dir = image_dir, width = 6.5, height = 7.5, pdf = TRUE)
...
plot_it(figIntrababyDiss, name = 'figIntrababyDiss', dir = image_dir, width = 5.5, height = 5.5, pdf = TRUE)
...
plot_it(figInterbabyDiss, name = 'figInterbabyDiss', dir = image_dir, width = 6.5, height = 3.5, pdf = TRUE)
...
tabHSP <- kable(tabHSP, format = 'latex', escape = F, booktabs = T, align = c('l','r','r','r'), linesep = "", digits = 2) %>%
  ...
  row_spec(0, bold = T) %>% 
  footnote(threeparttable = TRUE, 
           general = "Pearson correlations coefficients among estimates arising from three methods of hidden state character prediction. Predictions were made for all OTUs found in gut microbiome samples and/or from the Living Tree Project which could not be directly associated with trait observations. Only predictions which fell within acceptable phylogenetic distances to trait observations were considered (refer to Methods), thus N ranged from 8122 (Oxygen tolerance) to B vitamins (13511). IC: Independent Contrasts; SBT: Subtree Averaging; SCP: Weighted Squared-change Parsimony. Traits that were not amenable to hidden state prediction were omitted due to insufficient data.", 
...
plot_it(figSampling, type = 'supplementary figure', name = 'figSampling', dir = image_dir, width = 6.5, height = 7)
...
plot_it(figTreeTraits, type = 'supplementary figure', name = 'figTreeTraits', dir = image_dir, width = 7, height = 6.5)
...
plot_it(figThresholds, type = 'supplementary figure', name = 'figThresholds', dir = image_dir, width = 9, height = 8)
...
plot_it(figCWMsSuccGroup, type = 'supplementary figure', name = 'figCWMsSuccGroup', dir = image_dir, width = 7.5, height = 7.5)
...
plot_it(figSporulatorsTime, type = 'supplementary figure', name = 'figSporulatorsTime', dir = image_dir, width = 6.5, height = 6)
...
plot_it(figInterbabyDissTreat, type = 'supplementary figure', name = 'figInterbabyDissTreat', dir = image_dir, width = 6.5, height = 3.5)
